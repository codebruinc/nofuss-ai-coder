  ...
  return (
    <div className="animate-fade-in">
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Choose NoFuss AI Coder?</h2>
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              We make website creation accessible, efficient, and enjoyable for everyone.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  No coding experience required. Our AI guides you through every step of the process.
                </p>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Build websites in hours, not weeks. Our AI accelerates the development process.
                </p>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Create websites that match your vision. Our AI adapts to your specific requirements.
                </p>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Learn as you build. Our AI explains concepts and code to help you understand web development.
                </p>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Build websites with the latest technologies and best practices in web development.
                </p>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Get help whenever you need it. Our AI is available to assist with updates and improvements.
                </p>
              </div>
            </div>
          </div>
